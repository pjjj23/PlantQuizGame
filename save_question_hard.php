...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    // Prepare and bind
    $stmt = $conn->prepare("INSERT INTO hard (Hcategory, Hcorrectanswer, Himgupload, Hpoint, Hquestion, HtypeQuestion, option1, option2, option3, option4) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?)");
