...
$sql = "SELECT * FROM easy ORDER BY RAND() LIMIT 20";
...
<body>
    ...
    <script>
        ...
        function displayQuestion() {
            ...
            questionText.textContent = question.Equestion;

            if (question.Eimgupload && question.EtypeQuestion === 'imageIdentification') {
                questionImage.style.display = 'block';
                const imagePath = `${question.Eimgupload}`;
            ...
            options.forEach((option, index) => {
                if (option) {
                    ...
                    button.addEventListener('click', () => {
                        ...
                        checkAnswer(`option${index + 1}`, question.Ecorrectanswer, question.Epoint);
                    });
        ...
        function createTrueFalseOptions(question) {
         ...
         function createFillInTheBlanks(question) {
            ...
            submitButton.addEventListener('click', () => {
                buttonClickSound.play();
                checkAnswer(input.value, question.Ecorrectanswer, question.Epoint);
            });
...
function checkAnswer(userAnswer, correctAnswer, points) {
    ...
    if (questions[currentQuestionIndex].EtypeQuestion === 'fillInTheBlanks') {
...
function getCorrectAnswerText(correctAnswer) {
    const question = questions[currentQuestionIndex];
    if (question.EtypeQuestion === 'fillInTheBlanks') {
