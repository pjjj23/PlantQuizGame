...
$sql = "SELECT * FROM hard ORDER BY RAND() LIMIT 20";
...
<body>
    ...
    <script>
        ...
        function displayQuestion() {
            ...
            questionText.textContent = question.Hquestion;

            if (question.Himgupload && question.HtypeQuestion === 'imageIdentification') {
        questionImage.style.display = 'block';
        const imagePath = `${question.Himgupload}`;
            ...
            options.forEach((option, index) => {
                if (option) {
                    ...
                    button.addEventListener('click', () => {
                        ...
                        checkAnswer(`option${index + 1}`, question.Hcorrectanswer, question.Hpoint);
                    });
        ...
        function createFillInTheBlanks(question) {
            ...
            submitButton.addEventListener('click', () => {
                buttonClickSound.play();
                checkAnswer(input.value, question.Hcorrectanswer, question.Hpoint);
            });
...
function checkAnswer(userAnswer, correctAnswer, points) {
    ...
    if (questions[currentQuestionIndex].HtypeQuestion === 'fillInTheBlanks') {
...
function getCorrectAnswerText(correctAnswer) {
    const question = questions[currentQuestionIndex];
    if (question.HtypeQuestion === 'fillInTheBlanks') {
