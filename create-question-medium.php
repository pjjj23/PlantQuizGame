...
<head>
    ...
    <title>Create Question MEDIUM</title>
...
<div class="action-buttons">
    ...
    <a href="manage_question_medium.php" class="action-button delete-button" title="Manage Questions">
        <i class="fas fa-trash-alt"></i>
    </a>
</div>  
    <form id="questionForm" action="save_question_medium.php" method="POST" enctype="multipart/form-data">
        <div class="form-container">
            <h1><i class="fas fa-question-circle icon"></i>Creating Question - <span style="color: #e74c3c">MEDIUM</span></h1>
    ...
    fetch('save_question_medium.php', {
        method: 'POST',
        body: formData
    })
