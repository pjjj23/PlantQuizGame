...
if (isset($_POST['delete'])) {
    $id = $_POST['id'];
    $sql = "DELETE FROM medium WHERE mediumID = ?";
...
<head>
    ...
    <title>Manage Medium Questions - FloraQuiz</title>
...
<div class="container mt-5">
                        ...
                        <tbody>
                            ...
                            if ($result->num_rows > 0) {
                                while($row = $result->fetch_assoc()) {
                                    echo "<tr>";
                                    echo "<td>".$row["mediumID"]."</td>";
                                    echo "<td>".$row["Mcategory"]."</td>";
                                    echo "<td>".$row["Mquestion"]."</td>";
                                    echo "<td>".$row["MtypeQuestion"]."</td>";
                                    echo "<td>".$row["Mcorrectanswer"]."</td>";
                                    echo "<td>".$row["Mpoint"]."</td>";
                                    echo "<td>
                                            <button type='button' class='btn btn-delete btn-sm' onclick='showDeleteModal(".$row["mediumID"].")'>
    ...
    <script>
        ...
        function goBack() {
        window.location.href='create-question-medium.php';
    }
    </script>
</body>
</html>
