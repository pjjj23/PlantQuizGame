...
if (isset($_POST['delete'])) {
    $id = $_POST['id'];
    $sql = "DELETE FROM hard WHERE hardID = ?";
...
<head>
    ...
    <title>Manage Hard Questions - FloraQuiz</title>
...
<div class="container mt-5">
                        ...
                        <tbody>
                            ...
                            if ($result->num_rows > 0) {
                                while($row = $result->fetch_assoc()) {
                                    echo "<tr>";
                                    echo "<td>".$row["hardID"]."</td>";
                                    echo "<td>".$row["Hcategory"]."</td>";
                                    echo "<td>".$row["Hquestion"]."</td>";
                                    echo "<td>".$row["HtypeQuestion"]."</td>";
                                    echo "<td>".$row["Hcorrectanswer"]."</td>";
                                    echo "<td>".$row["Hpoint"]."</td>";
                                    echo "<td>
                                            <button type='button' class='btn btn-delete btn-sm' onclick='showDeleteModal(".$row["hardID"].")'>
    ...
    <script>
        ...
        function goBack() {
        window.location.href='create-question-hard.php';
    }
    </script>
</body>
</html>
